...
class findViewController: UIViewController {
    ...
    func initFindPasswordV(){
        ...
        verifyBtn.addTarget(self, action: #selector(findViewController.startCount), for: .touchUpInside)
        ...
        resetPasswordBtn.addTarget(self, action: #selector(findViewController.resetPassword), for: .touchUpInside)
