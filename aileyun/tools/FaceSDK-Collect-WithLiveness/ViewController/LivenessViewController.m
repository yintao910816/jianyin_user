        ...
        switch (remindCode) {
            case LivenessRemindCodeOK: {
                ...
                if (images[@"bestImage"] != nil && [images[@"bestImage"] count] != 0) {
                    ...
                    NSString* base64Image = [data base64EncodedStringWithOptions: NSDataBase64EncodingEndLineWithLineFeed];
//                    UIImage* bestImage = [UIImage imageWithData:data];
                    NSLog(@"bestImage = %@",base64Image);
                    [self.delegate imageString: base64Image];
                }
